...
public class ButtonsTogetherScrollBarSkin implements ScrollBarSkin {
     ...
     * @param trackPainter          the {@link com.jtechdev.painter.MacWidgetsPainter} to use to paint the track.
     * @param scrollThumbPainter    the {@link com.jtechdev.painter.MacWidgetsPainter} to use to paint the scroll thumb.
