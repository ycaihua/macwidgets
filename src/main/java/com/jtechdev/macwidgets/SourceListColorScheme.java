...
/**
 * An interface to provide a set of {@link com.jtechdev.painter.MacWidgetsPainter}s and colors to use when painting a
 * {@link SourceList}.
 */
public interface SourceListColorScheme {

    /**
     * The {@link com.jtechdev.painter.MacWidgetsPainter} to use for drawing the {@link SourceList} selection when the
