...
public class TriAreaComponent {
	...
	/**
	 * Set's the background {@link com.jtechdev.painter.MacWidgetsPainter} that this {@code TriAreaComponent}
	 * uses.
	 * 
	 * @param backgroundPainter
	 *            the background {@link com.jtechdev.painter.MacWidgetsPainter} that this
